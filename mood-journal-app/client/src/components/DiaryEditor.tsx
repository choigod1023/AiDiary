    ...
    <>
      ...
      <div className="mb-6">
        <input
          ...
          className={`w-full p-3 text-2xl font-bold rounded-lg text-black bg-amber-50 border-2 focus:outline-none focus:ring-2 light:focus:ring-amber-400 bark:focus:ring--400 resize-none ${
            editData.useAITitle
      ...
      <div className="mb-6">
        <textarea
          ...
          rows={10}
          className="p-4 w-full text-lg text-black bg-amber-50 rounded-lg border-2 border-amber-600 resize-none focus:outline-none focus:ring-2 light:focus:ring-amber-400 bark:focus:ring--400 dark:bg-gray-700 dark:text-white dark:border-gray-600"
